...
//************************Patron inicial******************** */
    ...
    //Aplico el algoritmo de metrópolis para S aleatorio y lo guarda en un txt

    ofstream fich_aleatorio("neuronas_aleatorios.txt");
    ...
    ofstream fich_deformado("deformado.txt");
