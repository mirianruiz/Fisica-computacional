...
int main(){
    ...
    vector<double> Temperaturas = { 0.01, 0.05, 0.06, 0.07, 0.08, 0.09, 0.1, 0.15, 0.2 };
    ...
    for (double T : Temperaturas) {
        ...
        //Voy a guardar 
        nombre_aleatorio << "neuronas_aleatorios_varios_patrones_T_" << T << ".txt";
    ...
    for (double T : Temperaturas) {
        ...
        nombre_deformado << "deformado_varios_patrones_T_" << T << ".txt";
